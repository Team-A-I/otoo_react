      ...
      if (jsonContent && jsonContent.file) {
        try {
          ...
          if (fileExtension === 'txt') {
            response = await axiosIns.post('https://gnat-suited-weekly.ngrok-free.app/api/love/analysis', requestData, {
              headers: {
            ...
            response = await axiosIns.post('https://gnat-suited-weekly.ngrok-free.app/api/love/ocr', formData, {
              headers: {
