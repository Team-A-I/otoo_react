...
const SignUpPage = () => {
  ...
  const sendEmailVerification = async () => {
    try {
      const response = await axios.post(`https://717f-1-214-19-22.ngrok-free.app/email/${users.usersEmail}`, {});
  ...
  const submitUserInfo = async () => {
    try {
      const response = await axios.post("https://717f-1-214-19-22.ngrok-free.app/join", users);
