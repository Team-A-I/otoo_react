...
const SignUpPage = () => {
  ...
  const sendEmailVerification = async () => {
    try {
      const response = await axios.post(`https://otoo-java-jc2u3c5ukq-an.a.run.app/email/${users.usersEmail}`, {});
  ...
  const submitUserInfo = async () => {
    try {
      const response = await axios.post("https://otoo-java-jc2u3c5ukq-an.a.run.app/join", users);
