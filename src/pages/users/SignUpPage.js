...
const SignUpPage = () => {
  ...
  const sendEmailVerification = async () => {
    try {
      const response = await axios.post(`https://gnat-suited-weekly.ngrok-free.app/email/${users.usersEmail}`, {});
  ...
  const submitUserInfo = async () => {
    try {
      const response = await axios.post("https://gnat-suited-weekly.ngrok-free.app/join", users);
