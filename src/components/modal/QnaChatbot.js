// import { Grid, Button, Typography, Box, Tooltip, ThemeProvider, Modal, Paper, InputBase, IconButton } from '@mui/material';
...
//             <Box className='content' sx={{width:'100%',margin:0}}>
//               <Box className="chat_subtitle">
//                 <Typography variant="title_bold">{chatbotTitle}</Typography>
//               </Box>
//               <Box className="chatList_Box" sx={{height:'500px'}}>
