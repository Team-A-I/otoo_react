      ...
      if (jsonContent) {
        try {
          ...
          if (fileExtension === 'txt') {
            response = await axiosIns.post('https://717f-1-214-19-22.ngrok-free.app/api/conflict/analysis', requestData);
          } else {
            ...
            response = await axiosIns.post('https://717f-1-214-19-22.ngrok-free.app/api/conflict/ocr', formData);
          }
