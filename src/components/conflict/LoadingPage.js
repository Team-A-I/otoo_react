      ...
      if (jsonContent) {
        try {
          ...
          if (fileExtension === 'txt') {
            response = await axiosIns.post('https://ra.otoo.kr/api/conflict/analysis', requestData);
          } else {
            ...
            response = await axiosIns.post('https://ra.otoo.kr/api/conflict/ocr', formData);
          }
